...
class MyTestCase(unittest.TestCase):
    ...
    def test_requirements_with_requirements_txt(self):
    ...
    def test_requirements_many_spaces(self):
        ...
        output_set = requirements_parser.open_requirements('requirements_test.txt')
    ...
    def test_requirements_with_txt(self):

        dict_result = {"a", "d", "b", "c", "g", "j"}

        with open('requirements_test.txt', 'w') as file:
            file.write("a\n b\n c\n -r requirements_test2\n d\n")
    ...
    def test_requirements_with_empty_row(self):
